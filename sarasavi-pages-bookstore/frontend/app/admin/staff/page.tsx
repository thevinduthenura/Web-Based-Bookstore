    ...
    <div className="space-y-6 pb-12 selection:bg-emerald-900 selection:text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-900 hover:bg-emerald-900 text-white font-semibold text-xs shadow-sm active:scale-95 transition-all self-start sm:self-auto"
        >
      ...
      {feedback && (
        <div
          className={`p-3.5 rounded-2xl flex items-center justify-between text-xs border font-medium ${
        ...
        >
          <div className="flex items-center gap-2">
            {feedback.type === 'success' ? <CheckCircle className="w-4 h-4 shrink-0 text-emerald-600" /> : <AlertCircle className="w-4 h-4 shrink-0 text-rose-600" />}
            <span>{feedback.message}</span>
          </div>
          <button onClick={() => setFeedback(null)} className="hover:opacity-80 text-slate-500">
            <X className="w-4 h-4" />
          </button>
        </div>
      )}
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200/90 shadow-xs flex flex-col md:flex-row gap-3 items-center justify-between">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-full bg-slate-50 border border-slate-200 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600 focus:bg-white font-medium transition-all shadow-xs"
          />
        </div>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <select
            ...
            className="w-full md:w-auto px-4 py-2.5 rounded-full bg-slate-50 border border-slate-200 text-xs text-slate-800 focus:outline-none focus:border-emerald-600 focus:bg-white font-semibold font-sans transition-all shadow-xs"
          >
                    ...
                    <tr key={staff.id} className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="font-bold text-slate-900 flex items-center gap-2.5">
                          <div className="w-7 h-7 rounded-full bg-emerald-100 text-emerald-950 border border-emerald-300 flex items-center justify-center text-[11px] font-bold font-sans">
                            {staff.fullName.charAt(0)}
                          </div>
                          <span className="text-slate-900">{staff.fullName}</span>
                        </div>
                      </td>

                      <td className="py-3.5 px-4">
                        <div className="text-emerald-800 font-bold text-xs">@{staff.username}</div>
                        {staff.itNumber && (
                          <div className="text-slate-500 text-[11px] font-medium">{staff.itNumber}</div>
                        )}
                      </td>

                      <td className="py-3.5 px-4 text-slate-700 text-xs font-normal">{staff.email}</td>

                      <td className="py-3.5 px-4">
                        <span
                          className={`inline-block px-2.5 py-1 rounded-full border text-[11px] font-sans font-semibold ${
                            roleObj ? roleObj.color : 'bg-slate-100 border-slate-200 text-slate-800'
                          }`}
                        >
                          {staff.role}
                        </span>
                      ...
                      <td className="py-3.5 px-4">
                        {staff.active ? (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-950 border border-emerald-300 text-[11px] font-bold font-sans">
                            <CheckCircle className="w-3.5 h-3.5 text-emerald-700" /> Active
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-rose-100 text-rose-950 border border-rose-300 text-[11px] font-bold font-sans">
                            <XCircle className="w-3.5 h-3.5 text-rose-700" /> Deactivated
                          </span>
                        )}
                      </td>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="p-2 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 hover:text-emerald-800 hover:bg-emerald-50 hover:border-emerald-300 transition-all shadow-xs"
                          ...
                          <button
                            ...
                            className={`p-2 rounded-xl border transition-all shadow-xs ${
                              staff.active
                                ? 'bg-slate-50 border-slate-200 text-slate-700 hover:text-amber-800 hover:bg-amber-50 hover:border-amber-300'
                          ...
                          <button
                            ...
                            className="p-2 rounded-xl bg-rose-50 border border-rose-200 text-rose-700 hover:bg-rose-100 hover:border-rose-300 transition-all shadow-xs"
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 max-w-lg w-full shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 text-slate-900">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Create Administrator Account</h2>
                  <p className="text-[11px] text-slate-500 font-medium">Module 1 (Gunathilaka) - RBAC Provisioning</p>
                </div>
              </div>
              <button 
            ...
            <div className="mt-4 p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 space-y-1.5 text-[11px] text-slate-700">
              <div className="flex items-center gap-1.5 font-bold text-emerald-950">
                <ShieldCheck className="w-4 h-4 text-emerald-700" />
                <span>Account Creation Rules and Standards:</span>
              </div>
              <ul className="space-y-1 text-slate-600 pl-5 list-disc">
                <li><strong className="text-slate-900">Username Rule:</strong> 3-30 characters, letters/numbers/underscores only.</li>
                <li><strong className="text-slate-900">Password Rule:</strong> Minimum 6 characters required.</li>
                <li><strong className="text-slate-900">Full Name:</strong> Minimum 3 characters (legal staff name).</li>
                <li><strong className="text-slate-900">Role Authority:</strong> Must select an authorized module role.</li>
                <li><strong className="text-slate-600">IT Number:</strong> Automatically handled (no manual entry needed).</li>
              </ul>
            </div>
            ...
            <form onSubmit={handleCreateStaff} className="mt-4 space-y-3.5 text-xs">
              <div>
                <label className="block text-slate-800 font-semibold mb-1">Full Legal Name *</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600 focus:bg-white font-medium"
                />
              </div>

              <div>
                <label className="block text-slate-800 font-semibold mb-1">Corporate Email Address *</label>
                <input
                  type="email"
                  required
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600 focus:bg-white font-normal"
                />
              </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <button
                      ...
                      className="text-[10px] text-emerald-800 hover:text-emerald-950 font-bold hover:underline flex items-center gap-0.5"
                    >
                      <Sparkles className="w-2.5 h-2.5 text-emerald-600" /> Auto-fill
                    </button>
                  </div>
                  <input
                    type="text"
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600 focus:bg-white font-semibold text-emerald-800"
                  />
                </div>

                <div>
                  <label className="block text-slate-800 font-semibold mb-1">Password (min 6 chars) *</label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3.5 pr-9 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-emerald-600 focus:bg-white"
                    />
                    <button
                      type="button"
              ...
              <div>
                <label className="block text-slate-800 font-semibold mb-1">Role / Module Authority *</label>
                <select
                  value={addForm.role}
                  onChange={(e) => setAddForm({ ...addForm, role: e.target.value as StaffRole })}
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:border-emerald-600 focus:bg-white font-semibold font-sans"
                >
                  {ROLES.map((r) => (
                    <option key={r.value} value={r.value}>
                      {r.label} ({r.desc})
              ...
              <div className="pt-4 flex items-center justify-end gap-2.5">
                <button
                  type="button"
                  onClick={() => setIsAddModalOpen(false)}
                  className="px-4 py-2.5 rounded-full bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 font-medium text-xs transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-6 py-2.5 rounded-full bg-slate-900 hover:bg-emerald-900 text-white font-semibold text-xs shadow-md transition-colors disabled:opacity-50"
                >
      ...
      {isEditModalOpen && selectedStaff && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 max-w-md w-full shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 text-slate-900">
            <div className="flex items-center justify-between pb-4 border-b border-slate-100">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-emerald-100 text-emerald-900 flex items-center justify-center border border-emerald-200">
                  <Edit3 className="w-4 h-4 text-emerald-700" />
                </div>
                <div>
                  <h2 className="text-sm font-bold text-slate-900">Edit Admin Account</h2>
                  <p className="text-[11px] text-emerald-800 font-bold font-sans">@{selectedStaff.username}</p>
                </div>
              </div>
              <button 
            ...
            <form onSubmit={handleUpdateStaff} className="mt-4 space-y-3.5 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 focus:outline-none focus:border-emerald-600 focus:bg-white font-medium"
                />
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-800 font-semibold mb-1">Username</label>
                  <input
                    type="text"
                    required
                    value={editForm.username}
                    onChange={(e) => setEditForm({ ...editForm, username: e.target.value })}
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-emerald-800 font-bold focus:outline-none focus:border-emerald-600 focus:bg-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 focus:outline-none focus:border-emerald-600 focus:bg-white font-normal"
                  />
                </div>
              </div>

              <div>
                <label className="block text-slate-800 font-semibold mb-1">Role / Authority Level</label>
                <select
                  value={editForm.role}
              ...
              <div>
                <label className="block text-slate-800 font-semibold mb-1">
                  Change Password <span className="text-slate-500 font-normal">(Leave blank to keep existing)</span>
                </label>
                <div className="relative">
                  <input
      ...
      {isDeleteModalOpen && selectedStaff && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white border border-rose-200 rounded-3xl p-6 max-w-md w-full shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 text-slate-900">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-600 font-medium font-sans">ID #{selectedStaff.id}: @{selectedStaff.username}</p>
              </div>
            </div>

            <p className="text-xs text-slate-600 mb-4 leading-relaxed font-normal">
              Are you sure you want to delete <strong className="text-slate-900 font-bold">{selectedStaff.fullName}</strong> (@{selectedStaff.username})? 
            ...
            <div className="flex items-center justify-end gap-2.5 pt-2">
              <button
                ...
                className="px-4 py-2.5 rounded-full bg-slate-100 hover:bg-slate-200 border border-slate-200 text-xs font-medium text-slate-700 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="px-5 py-2.5 rounded-full bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs shadow-md transition-colors disabled:opacity-50"
              >
